...
final class CheckCommand
{
    ...
    /**
     * @param list<string> $args
     * @return array{config:string,preset:string,format:string,summaryJson:string,reportDir:string,changedOnly:bool,changedBase:string,failOn:string,paths:list<string>,help:bool}
     */
